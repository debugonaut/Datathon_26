...
export default function LoginPage() {
  ...
  return (
    <div style={{
      ...
      {/* ── Diagonal purple hero ── */}
      <div style={{
        position: 'absolute',
        top: 0, left: 0, right: 0,
        height: '52%',
        background: 'linear-gradient(135deg, #5B52E8 0%, #6C63FF 60%, #3B82F6 100%)',
        clipPath: 'polygon(0 0, 100% 0, 100% 48%, 0 100%)',
        zIndex: 0,
      }} />
      ...
      {/* ── Big tagline bottom-left of hero ── */}
      <div style={{
        position: 'absolute',
        top: '18%', left: 32,
        ...
        <div style={{
          ...
          marginTop: 10, lineHeight: 1.65, maxWidth: 220,
        }}>
          Sign in to track and resolve<br />hostel complaints in real time.
        </div>
      </div>

      {/* ── Form card — anchored bottom-right, no border-radius on 2 sides ── */}
      <div style={{
        position: 'absolute',
        bottom: 0, right: 0,
        width: 360,
        ...
        <div style={{ fontSize: 18, fontWeight: 700, color: '#F1F5F9', letterSpacing: '-0.03em', marginBottom: 3 }}>
          Sign in
        </div>
        <div style={{ fontSize: 12, color: '#475569', marginBottom: 22 }}>
          Sign in to your MITAOE account
        </div>
        ...
        <button
          ...
          style={{
            ...
            marginBottom: 18, opacity: googleLoading ? 0.7 : 1,
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
          ...
          <span style={{ fontSize: 10, color: '#1E293B', fontWeight: 600 }}>or sign in with email</span>
          <div style={{ flex: 1, height: 1, background: 'rgba(255,255,255,0.07)' }} />
        </div>
        ...
        <form onSubmit={handleEmailLogin}>
          <div style={{ marginBottom: 12 }}>
            <div style={{ fontSize: 10, fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', color: '#475569', marginBottom: 5 }}>
              Email
            </div>
            <input
              type="email"
      ...
      <div style={{
        ...
        {[
          { bg: '#6C63FF', shadow: '0 0 8px rgba(108,99,255,0.7)' },
          { bg: '#10B981', shadow: 'none' },
          { bg: '#F59E0B', shadow: 'none' },
