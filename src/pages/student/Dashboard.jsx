    ...
    <div className={`app-main ${isSidebarMinimized ? 'minimized' : ''}`}>
      <div className="app-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          ...
          <div>
            <div className="header-title" style={{fontSize: 15, fontWeight: 700}}>Room {userDoc?.roomNumber}</div>
            <div style={{fontSize: 11, color: 'var(--text-3)', marginTop: 1}}>{hierarchyNames.building} · Floor {hierarchyNames.floor}</div>
          </div>
        </div>
        <div className="header-actions" style={{display:'flex', alignItems:'center', gap:16}}>
          ...
          <div style={{display:'flex', alignItems:'center', gap:10, borderLeft:'1px solid var(--border)', paddingLeft:16}}>
            <div style={{textAlign:'right'}}>
              ...
              <div style={{fontSize:11, color:'var(--text-3)'}}>Student</div>
            </div>
